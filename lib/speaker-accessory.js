...
export class YotoSpeakerAccessory {
  ...
  setupSmartSpeakerService () {
    ...
    // Report AirPlay as enabled. This does not make the Yoto an AirPlay target, and the
    // Home app still shows "Controls not available" (it only offers live controls for real
    // AirPlay speakers); the speaker is only usable from scenes and automations.
