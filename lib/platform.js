  ...
  async startAccount () {
    ...
    try {
      ...
      if (this.playbackAccessoryConfig.smartSpeakerEnabled) {
        this.log.info('The External Smart Speaker is a legacy option: the Home app shows "Controls not available" for it. For play/pause, volume and card inputs from the iPhone remote, turn on the TV Playback Accessory instead.')
      }
