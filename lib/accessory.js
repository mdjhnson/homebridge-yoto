...
import { getPlaybackAccessoryConfig, getSleepTimerIncrement } from './service-config.js'
...
export class YotoPlayerAccessory {
  ...
  syncSleepTimerFromPlayback () {
    ...
    if (sleepTimerActive === true && typeof sleepTimerSeconds === 'number' && sleepTimerSeconds > 0) {
      ...
      // Running, but the player hasn't said how long is left
  ...
  setSleepTimerEnd (endsAt) {
    ...
    if (endsAt !== null && !this.#sleepTimerTick) {
